...
|插件名|功能|下载|编译日期|
| :----: | :----: | :----: | :----: |
| [PassWall](https://github.com/Openwrt-Passwall/openwrt-passwall) | 科学工具 | [PassWall_26.7.1](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/PassWall_26.7.1_aarch64_a53_all_sdk_22.03.7.run) |2026-07-01|
| [PassWall2](https://github.com/Openwrt-Passwall/openwrt-passwall2) | 科学工具 | [PassWall2_26.6.16](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/PassWall2_26.6.16_aarch64_a53_all_sdk_22.03.7.run) |2026-06-18|
| [SSR-Plus](https://github.com/fw876/helloworld) | 科学工具 | [SSR-Plus_196-2](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/SSR-Plus_196-2_aarch64_a53_all_sdk_22.03.7.run) |2026-07-01|
| [OpenClash](https://github.com/vernesong/OpenClash) | 科学工具 | [OpenClash_0.47.110](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/OpenClash_0.47.110+aarch64_core.run) |2026-06-30|
...
例
```console
sh PassWall_26.7.1_aarch64_a53_all_sdk_22.03.7.run
```
如果文件不在当前路径记得填写路径，下例
```console
sh /tmp/upload/PassWall_26.7.1_aarch64_a53_all_sdk_22.03.7.run
```
